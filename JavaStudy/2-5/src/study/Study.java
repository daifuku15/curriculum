...
public class Study {
    ...
    public static void main(String args[]) {
        ...
        /*
         * [ここへ記述]
         *MapであるshopMapの２番目の要素にshohinListの２番目の値を代入しキーの値「180」と紐づける
         */
        ...
        for(int num=0;num < shopMap.size();num++) {
            System.out.print(shohinList.get(num));
            System.out.print("=");
            System.out.print(shopMap.get(shohinList.get(num)));
